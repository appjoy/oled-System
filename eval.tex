...
by modifying the screenrecord command code,
...
covers dark and light modes for 5 activities each for 6 popular Google Apps:
...
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}}|p{10mm}|c|c|c|c|c|}
	...
	\hline
	\multirow{2}{*}{Pixel 2} & dark   & 21.6 ( 23.3) & 12.8 ( 13.5) & 4.2 ( 3.9) & 3.5 ( 2.3) \\
	                         % \cline{2-6}
	                         & light  & 7.2 ( 7.5) & 5.4 ( 5.5) & 1.7 ( 1.5) & 1.7 ( 1.5) \\
	\hline
	\multirow{2}{*}{Moto Z3} & dark   & 17.3 ( 20.1) & 11.8 ( 13.7) & 3.1 ( 3.1) & 3.5 ( 3.6) \\
	                         % \cline{2-6}
	                         & light  & 5.0 ( 5.6) & 4.8 ( 5.5) & 2.2 ( 2.0) & 2.3 ( 2.1) \\
	\hline
    \multirow{2}{*}{Pixel 4} & dark   & 18.9 ( 17.0) & 13.1 ( 11.8) & 4.3 ( 4.5) & 4.6 ( 4.6) \\
                             % \cline{2-6}
                             & light  & 6.5 ( 7.4) & 7.5 ( 7.9) & 2.6 ( 1.0) & 2.7 ( 0.9) \\
	\hline
\end{tabular*}
...
for the activity screenshots with 100x sampling.
...
almost identical and consistent across the 3 phones (and hence robust
to phone diversities),
% (within 10\%),
and both are significantly lower than that of LMLR and NLM.
...
Figure~\ref{fig:smapling_error} left column shows the additional
prediction error of P-LMLR when increasing the pixel sampling ratio
compared to that of P-LMLR without sampling,
for the activity screenshots from 6 Google apps on the 3 phones.
...
Figure~\ref{fig:smapling_error} right column shows how the sampling
